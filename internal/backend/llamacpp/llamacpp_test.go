...
func (f fakeRunner) Run(_ context.Context, _ string, _ []string) ([]byte, []byte, error) {
	return []byte(`[{"build_commit":"b9180","model_size":396705472,"n_batch":512,"n_ubatch":128,"n_threads":8,"n_gpu_layers":30,"flash_attn":true,"fit_min_ctx":4096,"type_k":"q8_0","type_v":"q8_0","avg_ts":12.5,"samples_ts":[12.0,13.2]}]`), nil, nil
}
...
func TestFit(t *testing.T) {
	...
	assert.InDelta(t, 13.2, out.MaxTS, 0.0001)
}
